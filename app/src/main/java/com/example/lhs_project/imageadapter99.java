...
public class imageadapter99 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b99,R.drawable.b99b};
    public imageadapter99(Context mComtex) { this.mComtex = mComtex;
    }

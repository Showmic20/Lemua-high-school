...
public class imageadapter08 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b08,R.drawable.b08b};
    public imageadapter08(Context mComtex) { this.mComtex = mComtex;
    }

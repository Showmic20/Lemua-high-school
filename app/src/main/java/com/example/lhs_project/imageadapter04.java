...
public class imageadapter04 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b04,R.drawable.b04a};
    public imageadapter04(Context mComtex) { this.mComtex = mComtex;
    }

...
public class imageadapter94 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b94,R.drawable.b94b};
    public imageadapter94(Context mComtex) { this.mComtex = mComtex;
    }

...
public class imageadapter06 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b06,R.drawable.b06b,R.drawable.b06c};
    public imageadapter06(Context mComtex) { this.mComtex = mComtex;
    }

...
public class imageadapter19 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b18,R.drawable.b18b,R.drawable.b18c};
    public imageadapter19(Context mComtex) { this.mComtex = mComtex;
    }

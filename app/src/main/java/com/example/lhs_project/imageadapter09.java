...
public class imageadapter09 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b09,R.drawable.b09b,R.drawable.b09c,R.drawable.b09d};
    public imageadapter09(Context mComtex) { this.mComtex = mComtex;
    }

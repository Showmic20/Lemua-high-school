...
public class imageadapter03 extends BaseAdapter {
    private Context mComtex;
    public int[] imagerArray={R.drawable.b03,R.drawable.b03a,R.drawable.b03b};
    public imageadapter03(Context mComtex) { this.mComtex = mComtex;
    }
